...
{{ HTML::style('js/plugins/pnotify/pnotify.custom.min.css') }}
...
//=========================================================================================
        ...
        $("#form-2").submit(function (e) {
            ...
            $.ajax({
                ...
                success: function (aData) {
                    aData = aData.map(function (e) {
                        return [e.razon_social, e.kilogramos]
                    });
                ...
                error: function (data) {
                    new PNotify({
                        title: 'Oh No!',
                        text: data.responseJSON.error.join('<br>'),
                        type: 'error'
                    });
        ...
        $("#form-3").submit(function (e) {
            ...
            $.ajax({
                ...
                success: function (aData) {
                    aData = aData.map(function (e) {
                        return [e.descripcion, e.cantidad]
                    });
